...
static int test_source_set_frame_rate(struct video_source *s, unsigned int fps)
{
	return 0;
}

static int test_source_stream_on(struct video_source *s)
{
	return 0;
}

static int test_source_stream_off(struct video_source *s)
{
	return 0;
}
